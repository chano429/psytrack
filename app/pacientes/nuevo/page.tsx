...
export default function NuevoPaciente() {
  ...
  // Buscar el Rol al montar el componente
  useEffect(() => {
  ...
  const guardar = async () => {
    ...
    const payload: any = {
      ...
      antecedente_internacion: form.antecedente_internacion || false,
      ...
      valor_sesion: form.valor_sesion ? parseFloat(form.valor_sesion) : null
    };
  ...
  if (verificandoRol) {
      return <div className="flex items-center justify-center h-screen"><Loader2 className="animate-spin text-[#8C9C8E]" size={40} /></div>;
  }
    ...
    <div className="max-w-4xl mx-auto flex flex-col gap-6 pb-32 animate-in fade-in duration-500 relative">
      ...
      <div className="sticky top-4 z-40 bg-white border border-[#E8E3D9] shadow-md rounded-[2.5rem] p-5 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        ...
        <div className="flex flex-wrap items-center bg-[#FBF9F6] p-1.5 rounded-2xl border border-[#E8E3D9]">
          ...
          {/* BLOQUEO: Solo el profesional ve el icono de Clínica */}
          {rol !== 'secretaria' && (
      ...
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
        ...
        {pestana === 'cobertura' && (
          <div className="bg-white p-8 rounded-[2.5rem] border border-[#E8E3D9] shadow-sm relative overflow-hidden">
            ...
            <div className="mt-8 flex justify-between">
                ...
                {/* BLOQUEO: Solo el profesional puede pasar al paso 3 */}
                {rol !== 'secretaria' && (
        ...
        {/* PESTAÑA 3: CUADRO CLÍNICO (Protegido) */}
        {pestana === 'clinica' && (
          rol === 'secretaria' ? (
             <div className="bg-white p-16 rounded-[2.5rem] border-2 border-dashed border-[#E8E3D9] text-center shadow-sm">
                <AlertCircle className="mx-auto mb-4 text-[#B06043]" size={40} />
                <h3 className="text-xl font-black text-[#4A443C] mb-2">Acceso Restringido</h3>
                <p className="text-[#8A8175] font-medium max-w-sm mx-auto">No podés acceder a la sección clínica. El paciente ya puede ser creado.</p>
             </div>
          ) : (
          <div className="bg-white p-8 rounded-[2.5rem] border border-[#E8E3D9] shadow-sm relative overflow-hidden">
            <h2 className="text-xl font-bold text-[#4A443C] mb-8 border-b border-[#F2EFE9] pb-4 flex items-center gap-2">
